<template>
  <div class="about-page">
    <el-card class="about-card">
      <h2>关于本站 🎶</h2>
      <p>这里是 CGT48 谭思慧的个人应援存档站。域名为abm48.com均为本人所有</p>
      <p>主要用于记录直播中的唱歌切片时间点，方便大家剪辑唱歌视频/音频,以及考古和安利</p>
      <p>可找我做同款或者定制应援站</p>  
      <el-divider />
      
      <h3>💗 关于安利</h3>
      <p>安利页面收录了与谭思慧相关的 B站视频和微博内容，可以在页面顶部切换平台，并按账号、关键词、发布时间和互动数据进行检索与排序。</p>
      ...
      <h4>🔴 微博安利</h4>
      <p>微博部分同样来自固定账号，包括谭思慧本人、官方账号以及粉丝产出和资料账号。「DongganCR」与「CGT48-谭思慧」为免筛选账号，微博全部保留（包括转发）；其他账号仅保留正文含有「谭思慧超话」的原创微博，并排除转发帖。</p>
      ...
      <p class="project-links">
        <a href="https://github.com/30466/tsh-fansite" target="_blank" rel="noopener noreferrer">本站源代码</a>
