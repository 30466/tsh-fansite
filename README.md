...
这是为 **CGT48 成员谭思慧** 建立的个人应援存档站，集中整理直播唱歌切片、非唱歌类视频切片、口袋48录播、B站与微博安利内容以及成员资料。
...
| 成员简介 | 关于本站 |
| :---: | :---: |
| <img src="screenshots/profile.jpg" width="560" alt="谭思慧成员简介" /> | <img src="screenshots/about.jpg" width="560" alt="关于本站" /> |
...
- 从口袋48接口读取谭思慧的录播记录，以次日 `06:00` 为日期归档边界。
...
- 从固定UP主列表中展示与谭思慧相关的视频。
- “谭思慧在此”单独位于第一行并保留全部视频，其他UP主从第二行开始。
- 支持账号筛选、精确/模糊检索、热门词、发布时间及播放互动数据排序。
- 搜索范围包括标题、简介和分P标题；命中分P时可直接跳转到对应分P。

#### 微博

- 展示谭思慧本人、官方账号以及粉丝产出和资料账号的微博。
- `DongganCR`、`CGT48-谭思慧` 单独位于第一行并全量保留（包括转发），其他账号仅保留正文含“谭思慧超话”的原创微博，并排除转发帖。
...
感谢谭思慧每天带来的动听歌声，也感谢持续整理录播、切片、返图和安利内容的各位老师。
