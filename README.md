...
- **API 数据**: 通过后端代理调用 [abm48.com](https://abm48.com) 公开 API 获取成员基本信息、总选排名等数据。
...
完整的直播录播回放系统，从口袋48 API 获取数据，支持弹幕、剪切等功能。

### 5. 迷你音乐播放器

全局迷你播放器，支持从 abm48.com 搜索歌曲并加入播放列表，支持顺序/单曲/随机播放模式。
...
| 分支 | 说明 |
| :---: | :--- |
| **lite** | 当前维护分支，支持在线剪切、录播回放、弹幕等功能。**以后只更新此分支** |
| main | 旧版主分支（已弃用） |
